/**
 * Test: Sheet-Pan Pierogies and Beets
 * Fixture: sheet-pan-pierogies-and-beets.html
 */
...
const FIXTURE_FILE = 'sheet-pan-pierogies-and-beets.html';
...
async function runTest() {
  ...
  const recipe = await scrapeRecipeFromHTML(html, `https://example.com/recipe`);
