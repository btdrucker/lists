/**
 * Test: Spinach Artichoke Wonderpot
 * URL: https://www.budgetbytes.com/spinach-artichoke-wonderpot/
 * Fixture: spinach-artichoke-wonderpot.html
 */
...
const FIXTURE_FILE = 'spinach-artichoke-wonderpot.html';
...
async function runTest() {
  ...
  const recipe = await scrapeRecipeFromHTML(html, `https://www.budgetbytes.com/spinach-artichoke-wonderpot/`);
