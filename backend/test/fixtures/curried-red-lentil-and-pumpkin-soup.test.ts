/**
 * Test: Budget Bytes - Curried Red Lentil and Pumpkin Soup
 * URL: https://www.budgetbytes.com/curried-red-lentil-and-pumpkin-soup/
 * Fixture: curried-red-lentil-and-pumpkin-soup.html
 */
...
const FIXTURE_FILE = 'curried-red-lentil-and-pumpkin-soup.html';
const EXPECTED_METHOD = 'WPRM'; // Expected: WPRM | DataAttributes | JSON-LD | HTML
...
async function runTest() {
  ...
  const recipe = await scrapeRecipeFromHTML(html, `https://www.budgetbytes.com/curried-red-lentil-and-pumpkin-soup/`);
