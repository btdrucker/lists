/**
 * Test: Bon Appétit - Sheet-Pan Pierogies and Beets
 * URL: https://www.bonappetit.com/recipe/sheet-pan-pierogies-and-beets
 * Fixture: bonappetit-pierogies-beets.html
 */
...
const FIXTURE_FILE = 'bonappetit-pierogies-beets.html';
...
async function runTest() {
  ...
  const recipe = await scrapeRecipeFromHTML(html, `https://www.bonappetit.com/recipe/sheet-pan-pierogies-and-beets`);
