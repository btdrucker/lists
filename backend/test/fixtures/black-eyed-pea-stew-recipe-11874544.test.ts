...
const FIXTURE_FILE = 'black-eyed-pea-stew-recipe-11874544.html';
...
async function runTest() {
  ...
  const recipe = await scrapeRecipeFromHTML(html, `https://www.seriouseats.com/easy-one-pot-black-eyed-pea-stew-swiss-chard-dill-5199802`);
